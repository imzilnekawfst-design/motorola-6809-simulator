...
public class Main extends JFrame {
    ...
    private Programme fenetreProgramme = new Programme();
    ...
    public Main() {
        ...
        fenetreProgramme.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
        ...
        JCheckBoxMenuItem itemProgramme = new JCheckBoxMenuItem("Programme");
        JCheckBoxMenuItem itemRAM = new JCheckBoxMenuItem("RAM");
        JCheckBoxMenuItem itemROM = new JCheckBoxMenuItem("ROM");

        itemProgramme.addActionListener(e -> fenetreProgramme.setVisible(itemProgramme.isSelected()));
        ...
        menuAffichage.add(itemProgramme);
